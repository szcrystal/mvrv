                    ...
                    <form class="form-horizontal" role="form" method="POST" action="/mypage">
                        ...
                        @foreach($tagGroupAll as $group)
                        	...
                        	<div class="tag-group form-group{{ $errors->has($group->slug) ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input id="{{ $group->slug }}" type="text" class="form-control tag-control" name="{{ $group->slug }}" value="{{ old($group->slug) }}" autocomplete="off">
                                    ...
                                    <ul style="display:none;" class="c-ul">
										<li class="ui-menu-item" role="presentation"><a class="ul-corner-all" tabindex="0"></a></li>
                                    </ul>
                                </div>
