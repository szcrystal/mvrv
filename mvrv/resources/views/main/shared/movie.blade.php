@if($atcl -> movie_url != '')
    ...
    @if(strpos($atcl->movie_url, 'vimeo') !== FALSE)
        <iframe src="https://player.vimeo.com/video/{{ $embed }}?color=03a5fc&title=0&portrait=0" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    ...
    @elseif(strpos($atcl->movie_url, 'youtube') !== FALSE)
        ...
        <iframe width="640" height="360" src="https://www.youtube.com/embed/{{ $embed }}" frameborder="0" allowfullscreen></iframe>
    @endif
@endif
